...
/*
    ...
    class DiscountFeature {
        ...
        @BeforeEach
        void setUp() {
            book = new Book("클린 코드", "로버트 마틴", "9789-0123456789" ,30000);
        }
        ...
        @Test
        @DisplayName("0% 할인율이면 가격이 변하지 않는다.")
        ...
        @Test
        @DisplayName("할인율이 50%를 초과하면 에러가 발생한다.")
