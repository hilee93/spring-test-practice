...
class BookRepositoryTest {
    ...
    class search {
        ...
        void findByAuthor() {
            ...
            bookRepository.save(new Book("리펙토링", "마틴 파울러", "333", 35000));
            // when
        ...
        @Test
        @DisplayName("ISBN으로도 책을 검색할 수 있다.")
        void findByIsbn() {
            // given
            bookRepository.save(new Book("클린 코드", "로버트 마틴", "978-11123456789", 30000));
            bookRepository.save(new Book("클린 아키텍처", "로버트 마틴", "978-2223456789", 32000));
            bookRepository.save(new Book("리펙토링", "마틴 파울러", "978-333456789", 35000));

            // when
            Optional<Book> found = bookRepository.findByIsbn("978-11123456789");
